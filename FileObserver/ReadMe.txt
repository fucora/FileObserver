========================================================================
    KONSOLENANWENDUNG: FileObserver-Projektübersicht
========================================================================

Diese FileObserver-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre FileObserver-Anwendung besteht.


FileObserver.vcxproj
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen FileObserver.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
